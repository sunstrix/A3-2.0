...
### Backend
- Linguagem: Java 21
- Framework Principal: Spring Boot 3.2.0 (Spring Web, Spring Security, Spring Data JPA, Spring Validation, Spring Thymeleaf)
...
Use o comando abaixo no seu terminal para baixar o projeto:
...
Você pode rodar a aplicação diretamente pelo terminal utilizando os comandos do Maven:
